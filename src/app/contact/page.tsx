...
export default function ContactPage() {
  ...
  return (
    <div id="contact" className="min-h-screen bg-black text-white px-6 md:px-12 py-12">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 divide-gray-800 divide-y md:divide-y-0">
        ...
        <motion.form
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
          className="pt-12 md:pt-0 space-y-6"
        >
          <input
            name="name"
            required
            placeholder="Your Name"
            className="w-full p-4 bg-black text-white rounded-xl border border-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-800"
          />
          <input
            name="email"
            type="email"
          ...
          <button
            ...
            className={`w-full px-6 py-3 bg-gray-800 text-white font-semibold rounded-xl hover:bg-gray-700 transition ${
              loading || !captcha ? "opacity-50 cursor-not-allowed" : ""
            }`}
          >
