export default function Footer() {
  return (
    ...
    <div>
      ...
      <ul className="space-y-2 text-gray-300 text-sm">
        <li><a href="/terms" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">Terms of Service</a></li>
        <li><a href="/privacy" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">Privacy Policy</a></li>
      </ul>
    </div>
  ...
  <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm text-gray-400">
    &copy; {new Date().getFullYear()} SmartKode. All rights reserved.
  </div>
</footer>
  );
}
