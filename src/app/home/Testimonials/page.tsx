...
const TestimonialsSection: React.FC = () => {
  ...
  // Mobile detection - Updated for better UX on small screens
  useEffect(() => {
    const checkMobile = (): void => {
      const width = window.innerWidth;
      setIsMobile(width < 640); // Small screens get minimal design, sm+ get full features
    };
    ...
    <>
      ...
      >
        <div className="relative z-10 max-w-6xl xl:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Main Testimonial - Hybrid Layout */}
          <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            
            {/* Mobile & Medium Screens Layout (Current Design) */}
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  ...
                  <div className="bg-gray-800 rounded-xl p-3 sm:p-4 border border-gray-700">
                    ...
                    <div className="text-white font-semibold text-sm sm:text-base leading-tight">
                      {currentData.location.split(',')[0]}
                    </div>
                  </div>
                </div>

                {/* Navigation - Simplified for small screens */}
                <div className="flex items-center justify-center">
                  {/* Only pagination dots for small screens, full navigation for medium+ */}
            ...
            {/* Large Screens Layout (Previous Design) */}
